...
fake_db =  {
    "user1":{
        ...
        "hashed_password":"$2b$12$w8wWHPQ4SoV8S7RjlCzXfuUSZcr1BWkmNECNDD..iWTQ9DPlvkL1y",
        "disabled":"False"            
    }
}
...
@app.get("/user/items")
async def read_users_items(current_user:User=Depends(get_current_active_user)):
